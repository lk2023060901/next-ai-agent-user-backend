...
export const agentRuns = sqliteTable("agent_runs", {
  ...
  coordinatorInputTokens: integer("coordinator_input_tokens").notNull().default(0),
  coordinatorOutputTokens: integer("coordinator_output_tokens").notNull().default(0),
  coordinatorTotalTokens: integer("coordinator_total_tokens").notNull().default(0),
  subAgentInputTokens: integer("sub_agent_input_tokens").notNull().default(0),
  subAgentOutputTokens: integer("sub_agent_output_tokens").notNull().default(0),
  subAgentTotalTokens: integer("sub_agent_total_tokens").notNull().default(0),
  totalInputTokens: integer("total_input_tokens").notNull().default(0),
  totalOutputTokens: integer("total_output_tokens").notNull().default(0),
  totalTokens: integer("total_tokens").notNull().default(0),
  taskSuccessCount: integer("task_success_count").notNull().default(0),
  taskFailureCount: integer("task_failure_count").notNull().default(0),
  startedAt: text("started_at"),
  endedAt: text("ended_at"),
  ...timestamps,
});
